    ...
    <View className="w-full overflow-hidden rounded-3xl bg-gray-900/80 shadow-2xl backdrop-blur-lg">
      <View className="relative px-6 pb-8 pt-8">
        ...
        <View className="mb-8 items-center">
          ...
          <Text className="text-4xl font-bold text-white">Game Type</Text>
        ...
        <View className="space-y-4">
          <TouchableOpacity
            ...
            <View className="flex-row items-center p-5">
              ...
              <View className="flex-1">
                <Text className="text-2xl font-bold text-white">Automatic Mode</Text>
                <Text className="text-base text-white/80">Quick play - 5 songs</Text>
                <Text className="mt-1 text-sm text-white/60">Start playing immediately</Text>
              </View>
          ...
          <TouchableOpacity
            ...
            <View className="flex-row items-center p-5">
              ...
              <View className="flex-1">
                <Text className="text-2xl font-bold text-white">Master Mode</Text>
                <Text className="text-base text-white/80">Customizable challenge</Text>
                <Text className="mt-1 text-sm text-white/60">Configure your game</Text>
              </View>
              <Ionicons name="chevron-forward" size={24} color="white" />
            </View>
          </TouchableOpacity>
